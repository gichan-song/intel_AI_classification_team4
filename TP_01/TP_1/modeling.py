...
X_train, X_test, Y_train, Y_test = np.load(
    '../naver_economy/news_data_max_20_wordsize_8607.npy', allow_pickle=True
)
print(X_train.shape, Y_train.shape)
print(X_test.shape, Y_test.shape)

model = Sequential()
model.add(Embedding(8607, 300, input_length=20))
...
model.save('../naver_economy/economy_category_classification_model_{}.h5'.format(fit_hist.history['val_accuracy'][-1]))
